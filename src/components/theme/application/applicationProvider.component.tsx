 ...
 * Can be improved with build-time processing with `@frayt/metro-config` package.
 *
 ...
 * Usually, can be provided by `@frayt/metro-config` package.
 *
 ...
 * ```
 * import React from 'react';
 * import { ApplicationProvider, Layout, Text } from '@frayt/components';
 ...
 * ```
 * import React from 'react';
 * import { ApplicationProvider, IconRegistry, Layout, Text } from '@frayt/components';
