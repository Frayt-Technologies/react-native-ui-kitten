 ...
 * import { ApplicationProvider, IconRegistry, Layout, Text, Icon, Button } from '@frayt/components';
 * import { EvaIconsPack } from '@frayt/eva-icons'; // <-- Make sure it is installed. npm i @frayt/eva-icons
 *
