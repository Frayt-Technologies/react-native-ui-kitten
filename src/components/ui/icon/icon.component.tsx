...
// In general, could be SVGProps if using @frayt/eva-icons or ImageProps if using Image.
 ...
 * In case of using `@frayt/eva-icons` package, Icon accepts any props for react-native-svg component.
 *
